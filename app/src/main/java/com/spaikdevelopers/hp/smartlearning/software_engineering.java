...
public class software_engineering extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(R.string.software_engineering_activity_title);
        ...
        bt_pdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(software_engineering.this,PDFlistSoftwareEngineering.class));
            }
        });
        ...
        bt_videotutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(software_engineering.this,viewer_video.class);
                intent.putExtra("youtube_videoLink","https://www.youtube.com/watch?v=4b1D1QFEel0&list=PLWPirh4EWFpG2b1L3CL-OAPYcM25jLjXH");
    ...
    public void LogOut(){
        ...
        finish();
        startActivity(new Intent(software_engineering.this,loginDemo2.class));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(itemid == R.id.homeId){
            startActivity(new Intent(software_engineering.this,home.class));
            return true;
        }
