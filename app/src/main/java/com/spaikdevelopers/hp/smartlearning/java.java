...
public class java extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(R.string.java_activity_title);
        ...
        bt_pdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(java.this,PDFlistJava.class));
            }
        });
        ...
        bt_videotutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(java.this,viewer_video.class);
                intent.putExtra("youtube_videoLink","https://www.youtube.com/watch?v=hf4k4OWlBfI&list=PLgH5QX0i9K3oAZUB2QXR-dZac0c9HNyRa");
    ...
    public void LogOut(){
        ...
        finish();
        startActivity(new Intent(java.this,loginDemo2.class));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(itemid == R.id.homeId){
            startActivity(new Intent(java.this,home.class));
            return true;
        }
